    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('people_pipeline', models.CharField(blank=True, choices=[('unknown', 'Unknown'), ('rejected', 'Rejected'), ('contacted', 'Contacted'), ('mission vision', 'Mission Vision'), ('conversations', 'Conversations'), ('potential recruit', 'Potential Recruit'), ('recruit', 'Recruit'), ('applicant', 'Applicant'), ('teammate', 'Teammate')], max_length=100, null=True)),
